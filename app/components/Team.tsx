  ...
  return (
    <div className="grid grid-cols-2 py-16">
      <div className="col-span-full lg:col-span-1">
        ...
        <p className="pb-6">
          <strong>Alexis</strong> et <strong>Nicolas</strong>&nbsp;ont une
          dizaine d&#39;années d&#39;expériences dans le développement et se
          sont rencontrés au sein d&#39;une startup fintech incubée par Meta.
          Après avoir travaillé ensemble sur plusieurs projets, ils décident de
          s&#39;associer autour de valeurs communes en 2020&nbsp;:{" "}
          <strong>Qraft</strong>&nbsp;est né. Aujourd&#39;hui, Qraft c&#39;est
          une équipe de 4 développeur.euse.s passionné.e.s, basée à Marseille.
        </p>
        <p>
